          ...
          <div className="space-y-6 font-mono">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="mailto:hello@blakstudio.dev" className="hover:text-brand transition-colors">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <a href="tel:+2347046059891" className="hover:text-brand transition-colors">
                    +2347046059891
                  </a>
                </div>
                <div>
                  ...
                  <a href="https://wa.me/2349077406839" target="_blank" rel="noopener noreferrer" className="hover:text-brand transition-colors">
                    +2349077406839
                  </a>
                </div>
              </div>
