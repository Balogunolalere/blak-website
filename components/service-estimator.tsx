  ...
  const [questions, setQuestions] = useState<EstimatorQuestion[]>([
    {
      ...
      options: [
        { id: "webapp", label: "Web Application", value: 2500000 },
        { id: "rebuild", label: "Website Rebuild", value: 1000000 },
        { id: "scraping", label: "Web Scraping", value: 580000 },
        { id: "ai", label: "AI Agent", value: 2000000 },
        { id: "automation", label: "Automation", value: 750000 },
      ],
      selected: null,
    },
    {
    ...
    },
    {
      ...
      options: [
        { id: "standard", label: "Standard (4-8 weeks)", value: 1 },
        { id: "accelerated", label: "Accelerated (3-4 weeks)", value: 1.3 },
        { id: "urgent", label: "Urgent (2 weeks)", value: 1.6 },
      ],
      selected: null,
    },
  ])
